...
![Problems](https://img.shields.io/badge/problems-59-orange?style=flat-square)
...
| | Feature | |
|---|---|---|
| 🧩 | **59 curated problems** | PyTorch ML engineering + geometry / spatial reasoning problems |
...
### 🧮 Tensor Manipulation — Working with structured data

Ragged, segmented, and grouped tensor patterns that appear constantly in data loading, packed sequences, loss masking, MoE routing, and contrastive learning. Core skill: composing `gather`, `scatter`, `cumsum`, and broadcasting without Python loops. The single highest-leverage pattern: **constraint between two sets → outer-product comparison + mask**.

| # | Problem | What You'll Implement | Difficulty | Freq | Key Concepts |
|:---:|---------|----------------------|:----------:|:----:|--------------|
| 41 | <a href="https://github.com/TianshuangQiu/TorchCode/blob/master/templates/41_segment_ids_from_lengths.ipynb" target="_blank">Segment IDs from Lengths</a> <a href="https://colab.research.google.com/github/TianshuangQiu/TorchCode/blob/master/templates/41_segment_ids_from_lengths.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `segment_ids_from_lengths(lengths)` | ![Easy](https://img.shields.io/badge/Easy-4CAF50?style=flat-square) | ⭐ | `repeat_interleave`, `cumsum`, inverse of `unique_consecutive` |
| 42 | <a href="https://github.com/TianshuangQiu/TorchCode/blob/master/templates/42_topk_gather.ipynb" target="_blank">Top-k Gather</a> <a href="https://colab.research.google.com/github/TianshuangQiu/TorchCode/blob/master/templates/42_topk_gather.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `topk_gather(scores, values, k)` | ![Medium](https://img.shields.io/badge/Medium-FF9800?style=flat-square) | ⭐ | `topk`, `gather`, index expansion, MoE/retrieval routing |
| 43 | <a href="https://github.com/TianshuangQiu/TorchCode/blob/master/templates/43_masked_pairwise_dist.ipynb" target="_blank">Masked Pairwise Distance</a> <a href="https://colab.research.google.com/github/TianshuangQiu/TorchCode/blob/master/templates/43_masked_pairwise_dist.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `masked_pairwise_dist(points, group_ids)` | ![Medium](https://img.shields.io/badge/Medium-FF9800?style=flat-square) | ⭐ | Outer-product broadcasting, `masked_fill`, contrastive learning |
| 44 | <a href="https://github.com/TianshuangQiu/TorchCode/blob/master/templates/44_ranks_within_groups.ipynb" target="_blank">Ranks Within Groups</a> <a href="https://colab.research.google.com/github/TianshuangQiu/TorchCode/blob/master/templates/44_ranks_within_groups.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `ranks_within_groups(group_ids)` | ![Medium](https://img.shields.io/badge/Medium-FF9800?style=flat-square) | ⭐ | `scatter_`, `cumsum`, `gather`, SQL `ROW_NUMBER()` equivalent |
| 45 | <a href="https://github.com/TianshuangQiu/TorchCode/blob/master/templates/45_per_group_linear.ipynb" target="_blank">Per-Group Linear (MoE Forward)</a> <a href="https://colab.research.google.com/github/TianshuangQiu/TorchCode/blob/master/templates/45_per_group_linear.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `per_group_linear(x, group_ids, W, b)` | ![Hard](https://img.shields.io/badge/Hard-F44336?style=flat-square) | ⭐ | Fancy indexing, `bmm`, conditional computation, MoE forward pass |

### 📐 Geometry — Spatial reasoning on the XY plane

Geometry and computational geometry problems that appear in computer vision (bounding box IoU, object detection), robotics (collision detection, path planning), and general ML engineering interviews. Problems use **numpy** rather than PyTorch. Core skill: recognising geometric constraints and implementing them with vectorised operations instead of Python loops.

| # | Problem | What You'll Implement | Difficulty | Freq | Key Concepts |
|:---:|---------|----------------------|:----------:|:----:|--------------|
| 46 | <a href="https://github.com/TianshuangQiu/TorchCode/blob/master/templates/46_rect_overlap.ipynb" target="_blank">Batch AABB Overlap</a> <a href="https://colab.research.google.com/github/TianshuangQiu/TorchCode/blob/master/templates/46_rect_overlap.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `rect_overlap(rects_a, rects_b)` | ![Easy](https://img.shields.io/badge/Easy-4CAF50?style=flat-square) | 🔥 | Separating Axis Theorem, broadcasting `(N,1,4)` vs `(1,M,4)` |
| 47 | <a href="https://github.com/TianshuangQiu/TorchCode/blob/master/templates/47_polygon_area.ipynb" target="_blank">Polygon Area (Shoelace)</a> <a href="https://colab.research.google.com/github/TianshuangQiu/TorchCode/blob/master/templates/47_polygon_area.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `polygon_area(vertices)` | ![Easy](https://img.shields.io/badge/Easy-4CAF50?style=flat-square) | ⭐ | Shoelace formula, `np.roll` for cyclic vertex shift |
| 48 | <a href="https://github.com/TianshuangQiu/TorchCode/blob/master/templates/48_point_in_polygon.ipynb" target="_blank">Point in Polygon</a> <a href="https://colab.research.google.com/github/TianshuangQiu/TorchCode/blob/master/templates/48_point_in_polygon.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `point_in_polygon(points, polygon)` | ![Medium](https://img.shields.io/badge/Medium-FF9800?style=flat-square) | ⭐ | Ray casting, broadcast `(P,1)` vs `(1,V)`, parity of crossings |
| 49 | <a href="https://github.com/TianshuangQiu/TorchCode/blob/master/templates/49_segment_intersect.ipynb" target="_blank">Batch Segment Intersection</a> <a href="https://colab.research.google.com/github/TianshuangQiu/TorchCode/blob/master/templates/49_segment_intersect.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `segment_intersect(segs_a, segs_b)` | ![Medium](https://img.shields.io/badge/Medium-FF9800?style=flat-square) | ⭐ | Cross-product orientation test, `(N,1,2,2)` vs `(1,M,2,2)` |
| 50 | <a href="https://github.com/TianshuangQiu/TorchCode/blob/master/templates/50_convex_hull.ipynb" target="_blank">Convex Hull (Graham Scan)</a> <a href="https://colab.research.google.com/github/TianshuangQiu/TorchCode/blob/master/templates/50_convex_hull.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `convex_hull(points)` | ![Hard](https://img.shields.io/badge/Hard-F44336?style=flat-square) | ⭐ | Graham scan O(N log N), `np.arctan2`, cross-product stack |
| 51 | <a href="https://github.com/TianshuangQiu/TorchCode/blob/master/templates/51_polygon_clip.ipynb" target="_blank">Polygon Clip (Sutherland-Hodgman)</a> <a href="https://colab.research.google.com/github/TianshuangQiu/TorchCode/blob/master/templates/51_polygon_clip.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `polygon_clip(subject, clip)` | ![Hard](https://img.shields.io/badge/Hard-F44336?style=flat-square) | 💡 | Sutherland-Hodgman, half-plane intersection, edge cases |
| 52 | <a href="https://github.com/TianshuangQiu/TorchCode/blob/master/templates/52_convex_polygon_iou.ipynb" target="_blank">Convex Polygon IoU</a> <a href="https://colab.research.google.com/github/TianshuangQiu/TorchCode/blob/master/templates/52_convex_polygon_iou.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `convex_polygon_iou(poly_a, poly_b)` | ![Medium](https://img.shields.io/badge/Medium-FF9800?style=flat-square) | 🔥 | IoU = inter/(area_a+area_b-inter), polygon clip + shoelace |
...
| 59 | <a href="https://github.com/TianshuangQiu/TorchCode/blob/master/templates/59_triangulate_polygon.ipynb" target="_blank">Polygon Triangulation (Ear-Clipping)</a> <a href="https://colab.research.google.com/github/TianshuangQiu/TorchCode/blob/master/templates/59_triangulate_polygon.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `triangulate_polygon(vertices)` | ![Hard](https://img.shields.io/badge/Hard-F44336?style=flat-square) | ⭐ | Ear-clipping, `(K,1,2)` vs `(1,K,2)` point-in-triangle broadcast, active vertex set |
