...
| # | Problem | What You'll Implement | Difficulty | Freq | Key Concepts |
|:---:|---------|----------------------|:----------:|:----:|--------------|
| 41 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/41_segment_ids_from_lengths.ipynb" target="_blank">Segment IDs from Lengths</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/41_segment_ids_from_lengths.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `segment_ids_from_lengths(lengths)` | ![Easy](https://img.shields.io/badge/Easy-4CAF50?style=flat-square) | ⭐ | `repeat_interleave`, `cumsum`, inverse of `unique_consecutive` |
| 42 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/42_topk_gather.ipynb" target="_blank">Top-k Gather</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/42_topk_gather.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `topk_gather(scores, values, k)` | ![Medium](https://img.shields.io/badge/Medium-FF9800?style=flat-square) | ⭐ | `topk`, `gather`, index expansion, MoE/retrieval routing |
| 43 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/43_masked_pairwise_dist.ipynb" target="_blank">Masked Pairwise Distance</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/43_masked_pairwise_dist.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `masked_pairwise_dist(points, group_ids)` | ![Medium](https://img.shields.io/badge/Medium-FF9800?style=flat-square) | ⭐ | Outer-product broadcasting, `masked_fill`, contrastive learning |
| 44 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/44_ranks_within_groups.ipynb" target="_blank">Ranks Within Groups</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/44_ranks_within_groups.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `ranks_within_groups(group_ids)` | ![Medium](https://img.shields.io/badge/Medium-FF9800?style=flat-square) | ⭐ | `scatter_`, `cumsum`, `gather`, SQL `ROW_NUMBER()` equivalent |
| 45 | <a href="https://github.com/duoan/TorchCode/blob/master/templates/45_per_group_linear.ipynb" target="_blank">Per-Group Linear (MoE Forward)</a> <a href="https://colab.research.google.com/github/duoan/TorchCode/blob/master/templates/45_per_group_linear.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" height="20"></a> | `per_group_linear(x, group_ids, W, b)` | ![Hard](https://img.shields.io/badge/Hard-F44336?style=flat-square) | ⭐ | Fancy indexing, `bmm`, conditional computation, MoE forward pass |
